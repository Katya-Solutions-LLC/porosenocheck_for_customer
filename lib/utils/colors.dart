...
Color shimmerPrimaryBaseColor = Colors.grey.withOpacity(0.6);
Color shimmerDarkBaseColor = Colors.grey.withOpacity(0.2);
Color shimmerLightBaseColor = Colors.grey.withOpacity(0.1);
